...
1. Parent reference is capable to hold  child’s object  but child’s reference  is incapable to hold  Parent’s object.
2. Child can not store parent object.
```
class GrandParent{
    int gold = 100;
...
![image](https://github.com/user-attachments/assets/6824c7bb-be7e-47d9-8a16-308831bd5717)
